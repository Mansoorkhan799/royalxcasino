  ...
  return (
    <>
      <BlogPostSchema
        title="How to Create a Royal X Casino Account and Login? - Step by Step Guide"
        description="Learn how to create your Royal X Casino account and login with our step-by-step guide. Get started playing games and earning rewards in minutes."
        slug="royal-x-casino-create-account-and-login"
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed">First, <Link href="/royal-x-casino-download" className="text-accent hover:underline font-semibold">download the Royal X Casino app</Link> from our official website. Once downloaded, install the app on your Android device.</p>
                    </div>
                  </div>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://royalexcasino.com.pk/blog/royal-x-casino-create-account-and-login"
            }
          })
        }}
      />
